...
## Environments
- Preview: https://main--commerce-boilerplate--bohnertchris.aem.page/
- Live: https://main--commerce-boilerplate--bohnertchris.aem.live/
...
1. Open the `commerce-boilerplate` directory in your favourite IDE and start coding :)
